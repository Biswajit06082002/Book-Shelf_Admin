...
const Categories = (props) => {
    ...
    const deleteCategory = (category, idx) => {
      ...
      fetch('https://calm-teal-cockroach-hose.cyclic.app/deleteCategories', {
      method: 'DELETE',
      body: JSON.stringify({
          _id: category._id, 
      }),
    ...
    useEffect(() => {
      fetch('https://calm-teal-cockroach-hose.cyclic.app/getAllCategories')
        .then((response) => response.json())
        .then((data) => {
       ...
       <div className="col-lg-4 col-md-6 pb-1" key={category._id}>
                <div className="cat-item d-flex flex-column border mb-4" style={{ padding: '30px' }}>
                    ...
                    >
                        ...
                        <img
                            className="img-fluid"
                            src={`https://calm-teal-cockroach-hose.cyclic.app/${category.imageUrl}`}
                            alt=""
                            style={{ height: '300px' }}
