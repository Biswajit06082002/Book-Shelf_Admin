...
const ProductDetails = (props) => {
    ...
    const addToTop = (product) => {
        ...
        fetch('https://calm-teal-cockroach-hose.cyclic.app/AddTopProducts', {
        method: 'POST',
        body: JSON.stringify({
            _id: product._id,
                ...
                <div id="product-carousel" className="carousel slide" data-ride="carousel" >
                    <div className="carousel-inner border" >
                        <div className="carousel-item active">
                            <img className="w-100 h-100" src= {`https://calm-teal-cockroach-hose.cyclic.app/${props.product.imageUrl1}`} alt="ProductImage1" />
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={`https://calm-teal-cockroach-hose.cyclic.app/${props.product.imageUrl2}`} alt="ProductImage2" />
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={`https://calm-teal-cockroach-hose.cyclic.app/${props.product.imageUrl3}`} alt="ProductImage3" />
                        </div>
