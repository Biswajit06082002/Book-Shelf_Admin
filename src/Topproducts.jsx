...
const Topproducts = (props) => {
    ...
    const deleteTopProduct = (topProducts, idx) => {
      ...
      fetch('https://calm-teal-cockroach-hose.cyclic.app/deleteTopProducts', {
      method: 'DELETE',
      body: JSON.stringify({
          _id: topProducts._id,
      ...
      useEffect(() => {
          fetch('https://calm-teal-cockroach-hose.cyclic.app/getTopProducts')
          .then((response) => response.json())
           .then((data) => {
              console.log(data);
              setTopProducts(data);
       ...
       <div className="col-lg-3 col-md-6 col-sm-12 pb-1" key={topProducts._id}>
         <div className="card product-item border-0 mb-4">
           <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0" style={{ height: '250px' }}>
             <img className="img-fluid w-100" src={`https://calm-teal-cockroach-hose.cyclic.app/${topProducts.imageUrl1}`} alt="" />
           </div>
